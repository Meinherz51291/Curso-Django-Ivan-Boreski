...
# Función para encontrar la palabra más repetida y su frecuencia en un diccionario de frecuencias
...
# Encontrar y mostrar la palabra más repetida y su frecuencia
palabra_mas_rep, frecuencia = palabra_mas_repetida(diccionario_frecuencias)
print(f"Palabra más repetida: {palabra_mas_rep} (Frecuencia: {frecuencia})")
